...
/// QorRegistryLegacyModule handles marketplace operations
pub struct QorRegistryLegacyModule;

impl QorRegistryLegacyModule {
    pub fn new() -> Self {
        Self
    }
}

impl RuntimeModule for QorRegistryLegacyModule {
    ...
    fn dispatch(&self, call_id: &str, tx: &Transaction, state: &mut State) -> Result<(), String> {
        match call_id {
            ...
            other => Err(format!("qor_registry_legacy: unknown call_id '{}'", other)),
        }
    }
}
