...
export default function QorIDPage() {
  const { address, profile, loading, error, generateNew, loadExisting } = useQorID();
    ...
    return (
      <div className="min-h-screen p-8">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl font-bold mb-8">Create or Load QorID</h1>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="text-left">
                <h2 className="text-xl font-semibold">Generate New QorID</h2>
  ...
  return (
    <div className="min-h-screen p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">QorID Profile</h1>
