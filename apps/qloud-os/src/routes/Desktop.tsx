...
import { QorWalletApp } from '../components/desktop/apps/QorWalletApp';
import { AbyssBrowserApp } from '../components/desktop/apps/AbyssBrowserApp';
import { QorExplorerApp } from '../components/desktop/apps/QorExplorerApp';
...
import { QorWriterApp } from '../components/desktop/apps/QorWriterApp';
import { QorCalcApp } from '../components/desktop/apps/QorCalcApp';
...
const appComponents: Record<string, React.ComponentType> = {
  ...
  miner: MinerApp,
  wallet: QorWalletApp,
  abyssBrowser: QorExplorerApp,  // Upgraded to QOR Explorer
  abyssExplorer: QorExplorerApp,
  ...
  abyssWriter: QorWriterApp,
  abyssCalc: QorCalcApp,
  craft: CraftApp,
