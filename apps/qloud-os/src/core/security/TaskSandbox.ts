 ...
 * 💀 Task Sandbox
 * 
 * PHASE OMEGA PART II: Enforces all QOR OS apps pass through secure sandbox
...
export class TaskSandbox {
   ...
   * PHASE OMEGA PART II: All QOR OS apps MUST pass through this
   */
