# QOR OS Alpha Deployment Script (PowerShell)
...
Write-Host "  QOR OS Alpha Deployment" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# Step 1: Build
Write-Host "[1/6] Building QOR OS for production..." -ForegroundColor Blue
...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "📍 Access QOR OS:" -ForegroundColor Cyan
if ($Domain) {
