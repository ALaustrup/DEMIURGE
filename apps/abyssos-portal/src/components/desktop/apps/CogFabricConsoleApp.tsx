...
export function CogFabricConsoleApp() {
  ...
  return (
    <div className="h-full flex flex-col min-h-0 p-6 space-y-6 overflow-auto">
      <div>
        <h2 className="text-2xl font-bold text-abyss-cyan mb-2">Cognitive Fabric Console</h2>
        <p className="text-sm text-gray-400">The mind of Demiurge</p>
      </div>
      
      {/* Stats Grid */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-abyss-navy/50 border border-abyss-cyan/20 rounded-lg p-4">
          <div className="text-sm text-gray-400 mb-1">Neural Vectors</div>
          <div className="text-2xl font-mono text-abyss-cyan">{vectorCount}</div>
        </div>
        
        <div className="bg-abyss-navy/50 border border-abyss-cyan/20 rounded-lg p-4">
          <div className="text-sm text-gray-400 mb-1">Active Spirits</div>
          <div className="text-2xl font-mono text-abyss-purple">{spirits}</div>
        </div>
        
        <div className="bg-abyss-navy/50 border border-abyss-cyan/20 rounded-lg p-4">
          <div className="text-sm text-gray-400 mb-1">Grid Peers</div>
          <div className="text-2xl font-mono text-abyss-cyan">{peers}</div>
        </div>
        
        <div className="bg-abyss-navy/50 border border-abyss-cyan/20 rounded-lg p-4">
          <div className="text-sm text-gray-400 mb-1">CGT Mined</div>
      ...
      <div className="bg-abyss-dark/50 border border-abyss-cyan/20 rounded-lg p-6 min-h-[300px]">
        <h3 className="text-lg font-bold text-abyss-cyan mb-4">Neural Graph</h3>
      ...
      {miningStats && (
        <div className="bg-abyss-navy/50 border border-abyss-cyan/20 rounded-lg p-4">
          <h3 className="text-lg font-bold text-abyss-cyan mb-4">Compute Mining Stats</h3>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="text-sm text-gray-400">Total Cycles</div>
              <div className="text-xl font-mono text-abyss-cyan">{miningStats.cycles.toLocaleString()}</div>
            </div>
            <div>
            ...
            <div>
              <div className="text-sm text-gray-400">Neural Contributions</div>
              <div className="text-xl font-mono text-abyss-cyan">{miningStats.neuralContributionScore.toFixed(2)}</div>
            </div>
            <div>
              <div className="text-sm text-gray-400">Total Reward (CGT)</div>
      ...
      {cognitionState && (
        <div className="bg-abyss-navy/50 border border-abyss-cyan/20 rounded-lg p-4">
          <h3 className="text-lg font-bold text-abyss-cyan mb-4">Cognition State</h3>
          <div className="space-y-2 text-sm">
            ...
            <div>
              <span className="text-gray-400">Active Spirits:</span>
